...
par(mfcol = c(2, 3))
par(mar = c(2.5,2.5,0,0), oma = c(4, 6, 0.5, 0.3))
...
text( x= 1.3, y = 1.2, labels = 'Alcedinidae', cex = 2)
...
mtext('larger flight muscles, shorter legs', cex = 2, side = 2, line = 0, outer = TRUE, padj = 0)
