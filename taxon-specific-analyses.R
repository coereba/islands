...
## Results presented in Tables S5 and S6 in supplemental
...
anova(lm(shape ~ log10(landbird.spp.richness) *sex + species, data = ptil))
...
# analyses - results summarized in Table S5
# keel length
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = duc))
...
# results summarized in Table S5
# keel
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = columbina))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = mac))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species , data = lox))
...
anova(lm(pc1~ log10(landbird.spp.richness) * sex + species , data = tiaris))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = tiaris))
...
anova(lm(pc1~ log10(landbird.spp.richness) * sex + species, data = todi))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = todi))
...
anova(lm(pc1 ~ log10(landbird.spp.richness) * sex + species, data = zost))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = zost))
...
summary(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = hum))
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = hum))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = rhip))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = mel))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = mon))
...
anova(lm(pc1 ~ log10(island.area) * sex + species, data = pach))
...
anova(lm(shape ~ log10(landbird.spp.richness) * sex + species, data = pach))
